...
# mensaje = ["C", "ó", "d", "i", "g", "o", " ", "s", "e", "c", "r", "e", "t", "o"]
# Utilizando slicing y concatenación, crea una nueva lista que contenga solo el mensaje "secreto"

mensaje = ["C", "ó", "d", "i", "g", "o", " ", "s", "e", "c", "r", "e", "t", "o"]

print(f"el mesanje es : {mensaje[7:14]}")
...
print(f"el centro es : {lista[len(lista)//2]}")
...
resultado = lista[:len(lista)//2][::-1] + lista[len(lista)//2:]
